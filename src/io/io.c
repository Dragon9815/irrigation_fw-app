...
const iodef_t inputs[NUM_INPUTS] = {
    [INPUT_AUTO1]            = { GPIOC, HAL_GPIO_PIN_0,  true,  true, 3 SECS },
    [INPUT_AUTO2]            = { GPIOC, HAL_GPIO_PIN_1,  true,  true, 3 SECS },
    [INPUT_AUTO3]            = { GPIOC, HAL_GPIO_PIN_2,  true,  true, 3 SECS },
    [INPUT_MANUAL1]          = { GPIOC, HAL_GPIO_PIN_3,  true,  true, 3 SECS },
    [INPUT_MANUAL2]          = { GPIOC, HAL_GPIO_PIN_4,  true,  true, 3 SECS },
    [INPUT_MANUAL3]          = { GPIOC, HAL_GPIO_PIN_5,  true,  true, 3 SECS },
